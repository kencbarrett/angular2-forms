System.register(['angular2/core', 'angular2/platform/browser', './forms/demo-form-sku', './forms/demo-form-sku-with-builder', './forms/demo-form-with-validations-explicit', './forms/demo-form-with-validations-shorthand', './forms/demo-form-with-custom-validations', './forms/demo-form-with-events', './forms/demo-form-ng-model'], function(exports_1) {
    ...
    var core_1, browser_1, demo_form_sku_1, demo_form_sku_with_builder_1, demo_form_with_validations_explicit_1, demo_form_with_validations_shorthand_1, demo_form_with_custom_validations_1, demo_form_with_events_1, demo_form_ng_model_1;
    var FormsDemoApp;
    return {
        setters:[
            function (core_1_1) {
